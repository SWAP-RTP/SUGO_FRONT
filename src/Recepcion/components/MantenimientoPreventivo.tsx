...
export const MantenimientoPreventivo = ({ control, errors }: MantenimientoPreventivoProps) => {
    ...
    return (
        <div className="formulario-grid sub-form">
            ...
            <div>
                <Controller control={control} name="observaciones" render={({ field }) => (<span className="p-float-label w-100"><InputText id="observaciones" className="select" {...field} /><label htmlFor="observaciones">Observaciones</label></span>)} />
            </div>
        </div>
    );
};